...
thumbnail: "/media/cach-su-dung-github-va-staticaly-de-toi-uu-website.jpg"
...
![Cách Sử Dụng Github và Staticaly Để Tối Ưu Website](/media/cach-su-dung-github-va-staticaly-de-toi-uu-website.jpg)
...
![Tạo tài khoản Github](/media/tao-tai-khoan-github.jpg)

Tiếp theo bạn chọn công việc hiện tại của bạn và các thông tin phía dưới rồi bấm vào Complete setup để hoàn tất.

![Hoàn tất thông tin tạo tài khoản Github](/media/hoan-tat-thong-tin-tao-tai-khoan-github.jpg)
...
![Tạo một project mới trên Github](/media/tao-project-moi-tren-github.jpg)

Sau đó nhập tên cho repository đó.

![Nhập một tên mới cho repository](/media/nhap-mot-ten-moi-cho-repository.jpg)
...
![Clone repository trên Github Desktop](/media/clone-repository-tren-github-desktop.jpg)
...
![Thư mục dự án vừa clone về](/media/thu-muc-du-an-vua-clone-ve.jpg)

Tại đây bạn tạo một folder bên trong folder đó bạn tạo các folder con khác để tí nữa mình copy file vào.

![Tạo thư mục để lưu trữ file](/media/tao-thu-muc-de-luu-tru-file.jpg)
...
![Deploy dự án sau khi hoàn tất](/media/deploy-du-an-sau-khi-hoan-tat.jpg)
...
![Các bước cần lưu ý khi sử dụng công cụ này](/media/cac-buoc-can-luu-y-khi-su-dung-cong-cu-nay.jpg)
