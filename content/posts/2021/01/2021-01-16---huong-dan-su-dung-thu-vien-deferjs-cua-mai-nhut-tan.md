...
thumbnail: "/media/user-guide-for-deferjs-library-by-mai-nhut-tan.jpg"
...
![Hướng Dẫn Sử Dụng Thư Viện DeferJS của Mai Nhựt Tân](/media/user-guide-for-deferjs-library-by-mai-nhut-tan.jpg)
...
![Basic optimizations](/media/basic-optimizations-wordpress.png)
...
![Optimizations for elements on the page](/media/optimizations-for-elements-on-the-page-wordpress.png)

Bạn giữ nguyên các giá trị ở đây.

#### Other customizations

![Other customizations](/media/other-customizations-wordpress.png)

Tại phần này bạn có thể tuỳ biến thêm một số thứ khác.

#### Ignore lazy-loading for some elements

![Ignore lazy-loading for some elements](/media/ignore-lazy-load-for-some-elements-wordpress.png)

Tại phần này bạn có thể loại trừ các phần tử khỏi lazy-loading.

#### Support for old browsers (IE9)

![Support for old browsers (IE9)](/media/support-for-old-browsers-ie9-wordpress.png)
