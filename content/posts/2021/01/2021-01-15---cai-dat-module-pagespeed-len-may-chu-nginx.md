...
thumbnail: "/media/install-module-page-speed-on-server-nginx.jpg"
...
![Cài đặt Module PageSpeed lên máy chủ Nginx](/media/install-module-page-speed-on-server-nginx.jpg)
...
![Ứng dụng Termius](/media/applications-termius.jpg)
...
![Kiểm tra Module PageSpeed](/media/check-module-page-speed.jpg)

Kế tiếp bạn reload lại trang rồi lựa chọn domain của mình.

![Kiểm tra Module PageSpeed Headers](/media/check-module-page-speed-headers.jpg)
